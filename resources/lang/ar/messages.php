...
return [
    ...
    'tables' => [
        ...
        'actions' => [
            ...
            'migrate-description' => 'سيؤدي هذا إلى حذف الجدول [:table] من قاعدة البيانات مع جميع صفوفه وإعادة إنشاء ملف الترحيل الخاص به. هل تريد المتابعة؟',
        ],
        'notifications' => [
            'migrated' => [
                'title' => 'عملية ناجحة',
            ...
            'not-owned' => [
                'title' => 'لم يتم ترحيل الجدول',
                'body' => 'الجدول [:table] موجود بالفعل في قاعدة البيانات ولم يتم إنشاؤه بواسطة منشئ الجداول، لذلك لم يتم تغييره.',
            ],
        ],
        'validation' => [
            'name-format' => 'استخدم صيغة snake_case: أحرف إنجليزية صغيرة وأرقام وشرطات سفلية، ويبدأ بحرف.',
            'name-exists' => 'الجدول [:table] موجود بالفعل في قاعدة البيانات.',
        ],
    ],
];
